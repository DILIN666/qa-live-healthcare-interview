<template>
  <div class="home">
      ...
      <div class="hero-content">
        ...
        <div class="hero-features">
          <div class="feature-item">
            ...
            <span>{{ t('home.service1') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.service2') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.service3') }}</span>
          </div>
        </div>
    ...
    <section class="active-rooms">
      ...
      <p class="section-subtitle">{{ t('home.doctorDesc') }}</p>
      <div class="rooms-grid">
        ...
        >
          ...
          <div class="room-footer">
            <a-button type="primary" block>{{ t('home.appointment') }}</a-button>
          </div>
        </div>
      </div>
    </section>
